...
export class CompleteregComponent implements OnInit {
  ...
  onSubmit() {
    ...
    if (this.setupForm.value.registrationStatusInput === 'registered') {
      this.router.navigate(['setup/activatereg']);
      } else if (this.setupForm.value.registrationStatusInput === 'starter') {
